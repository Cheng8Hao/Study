...
public class VUMeter extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mRecorder != null)
        	...
        	android.util.Log.d("duan114","maxAngle==="+maxAngle);
        	//android.util.Log.d("duan114","minAngle==="+minAngle);
        	//android.util.Log.d("duan114","angle==="+angle);
        ...
        android.util.Log.d("duan114","mCurrentAngle==="+mCurrentAngle);
        if(mCallBack!=null){
            mCallBack.getData(mCurrentAngle);
        }
        float w = getWidth();
        float h = getHeight();
        float pivotX = w/2;
