...
package com.dyc.factorymode.fmradio;
...
import com.dyc.factorymode.fmradio.FmStation.Station;
import com.dyc.factorymode.fmradio.dialogs.FmFavoriteEditDialog;
import com.dyc.factorymode.fmradio.views.FmScroller;
import com.dyc.factorymode.fmradio.views.FmScroller.EventListener;
import com.dyc.factorymode.fmradio.views.FmSnackBar;
...
public class FmMainActivity extends Activity implements FmFavoriteEditDialog.EditFavoriteListener {
    // Logging
    private static final String TAG = "FmMainActivity_Sagereal";
    ...
    private LinearLayout mNoHeadsetLayout = null;
    ...
    //zhousankui set setSpeakerPhoneOn for factory test 2018-05-02 begin
    int fmDefaultVolume = -1;
    //zhousankui set setSpeakerPhoneOn for factory test 2018-05-02 end
    private Button success;
    private Button mfail;
    //private Button failed = null;

    private Button buttonFmMainPresetStation0 = null;
    private Button buttonFmMainPresetStation1 = null;
    private Button buttonFmMainPresetStation2 = null;
    private Button buttonFmMainPresetStation3 = null;
    private Button buttonFmMainPresetStation4 = null;
            ...
            switch (v.getId()) {
                ...
                case R.id.play_button:
                    if (mService.getPowerStatus() == FmService.POWER_UP) {
                        ...
                        powerUpFm();
                        android.util.Log.d("wozuiku", " click play_button");
                    }
                    break;
                case R.id.fm_main_preset_station_0:
                    tuneStation(875);
                    break;

                case R.id.fm_main_preset_station_1:
                    tuneStation(957);
                    break;

                case R.id.fm_main_preset_station_2:
                    tuneStation(962);
                    break;

                case R.id.fm_main_preset_station_3:
                    tuneStation(974);
                    break;

                case R.id.fm_main_preset_station_4:
                    tuneStation(1062);
                    break;

                case R.id.fm_success_btn:
                    SharedPreferences.Editor editor = getSharedPreferences("result", MODE_PRIVATE).edit();
                    editor.putInt("Fm", 1);
                    editor.commit();
                    setSpeakerPhoneOn(false);
                    if (fmDefaultVolume != -1) {
                        fmDefaultVolume = mAudioManager.getStreamVolume(AudioManager.STREAM_MUSIC);
                        mAudioManager.setStreamVolume(AudioManager.STREAM_MUSIC, fmDefaultVolume, 0);
                    }
                    fmDefaultVolume = -1;
                    if (testmode == 0) {
                        startActivity(new Intent(FmMainActivity.this, com.dyc.factorymode.LoudSpeaker.class));
                    }else if (testmode == 3){
                        startActivity(new Intent(FmMainActivity.this, com.dyc.factorymode.TestReport.class));
                    }
                    finish();
                    break;
                case R.id.fm_fail_btn:
                    SharedPreferences.Editor editor1 = getSharedPreferences("result", MODE_PRIVATE).edit();
                    editor1.putInt("Fm", 2);
                    editor1.commit();
                    setSpeakerPhoneOn(false);
                    if (fmDefaultVolume != -1) {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case FmListener.MSGID_POWERUP_FINISHED:
                    if (mService.getPowerStatus() == FmService.POWER_UP) {
                        powerDownFm();//duanyecong
                    }
                    android.util.Log.d("wozuiku", " MSGID_POWERUP_FINISHED");
                    bundle = msg.getData();
                    ...
                    if (isPowerup) {
                        ...
                        //zhousankui set setSpeakerPhoneOn for factory test 2018-05-02 begin
                        fmDefaultVolume = mAudioManager.getStreamVolume(AudioManager.STREAM_MUSIC);
                        android.util.Log.d("zhousankui","fmDefaultVolume1 = "+fmDefaultVolume);
                        setSpeakerPhoneOn(false);
                    ...
                    if(isfm){
                        buttonFmMainPresetStation2.performClick();//duanyecong
                        isfm = false;
                    }else{
                ...
                case FmListener.MSGID_FM_EXIT:
                    //zhousankui set setSpeakerPhoneOn for factory test 2018-05-02 begin
                    Log.d("zhousankui", "MSGID_FM_EXIT");
                    setSpeakerPhoneOn(false);
                    if (fmDefaultVolume != -1) {
                        fmDefaultVolume = mAudioManager.getStreamVolume(AudioManager.STREAM_MUSIC);
                        mAudioManager.setStreamVolume(AudioManager.STREAM_MUSIC, fmDefaultVolume, 0);
    ...
    private final ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            if (!mService.isServiceInited()) {
                android.util.Log.d("wozuiku", "mService.isServiceInited()...." + mService.isServiceInited());
                ...
                if (mService.isDeviceOpen()) {
                    ...
                    updateMenuStatus();
                    //zhousankui add to power up 
                    android.util.Log.d("wozuiku", "mService.isDeviceOpen())===" + mService.isDeviceOpen());
                    powerUpFm();
                } else {
...
//            }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("liyang888", "FmMainActivity-->onCreate");
        // Bind the activity to FM audio stream.
        setVolumeControlStream(AudioManager.STREAM_MUSIC);
        setContentView(R.layout.fmactivity_main);
        try {
    ...
    public void onResume() {
        ...
        updateMenuStatus();
        mButtonPlay.performClick();//duanyecong
    }
    ...
    public void onPause() {
        ...
        //mScroller.onPause();
        mButtonPlay.performClick();//to stop fm when out factorymode
        super.onPause();
    }
    ...
    private void powerUpFm() {
        ...
        refreshPopupMenuItem(false);
        refreshPlayButton(false);
        //Log.d("zhousankui", "powerUpFm(),isAntennaAvailable==" + (isAntennaAvailable()));
        //zhousankui set the flag to true for fm speaker mode ,because in factorytest mode no need record function.
        if (null != mService)
    ...
    private void initUiComponent() {
        ...
        mNoHeadsetLayout = (LinearLayout) findViewById(R.id.no_headset);
        ...
        success = (Button) findViewById(R.id.fm_success_btn);
        mfail = (Button) findViewById(R.id.fm_fail_btn);
        SharedPreferences result = getSharedPreferences("testmode", Context.MODE_PRIVATE);
        testmode = result.getInt("isautotest", 0);
        //failed = (Button) findViewById(R.id.fm_failed);
        buttonFmMainPresetStation0 = (Button) findViewById(R.id.fm_main_preset_station_0);
        buttonFmMainPresetStation1 = (Button) findViewById(R.id.fm_main_preset_station_1);
        buttonFmMainPresetStation2 = (Button) findViewById(R.id.fm_main_preset_station_2);
        buttonFmMainPresetStation3 = (Button) findViewById(R.id.fm_main_preset_station_3);
        buttonFmMainPresetStation4 = (Button) findViewById(R.id.fm_main_preset_station_4);
    }
    ...
    private void registerButtonClickListener() {
        ...
        buttonFmMainPresetStation0.setOnClickListener(mButtonClickListener);
        buttonFmMainPresetStation1.setOnClickListener(mButtonClickListener);
        buttonFmMainPresetStation2.setOnClickListener(mButtonClickListener);
        buttonFmMainPresetStation3.setOnClickListener(mButtonClickListener);
        buttonFmMainPresetStation4.setOnClickListener(mButtonClickListener);
        success.setOnClickListener(mButtonClickListener);
        mfail.setOnClickListener(mButtonClickListener);
        //failed.setOnClickListener(mButtonClickListener);
    }
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions,
        ...
        if (requestCode == PERMISSION_REQUEST_POWER_ON) {
            ...
            if (granted == true) {
                if (mService != null) {
                    mService.setRecordingPermission(true);
                    android.util.Log.d("wozuiku", " PermissionsResult");
                    powerUpFm();
                }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_VOLUME_DOWN) {
            if (!isAntennaAvailable()) {
                ...
                editor.commit();
                if (testmode == 0) {
                    Intent intent = new Intent(FmMainActivity.this, com.dyc.factorymode.LoudSpeaker.class);
