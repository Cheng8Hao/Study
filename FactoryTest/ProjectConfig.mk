...
CUSTOM_KERNEL_IMGSENSOR = gc5025mipi_raw gc2385_mipi_raw
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = gc5025mipi_raw
...
CUSTOM_MODEM=WQ507_3GB1B8_4GB1B3
...
MTK_BUILD_VERNO = WQ507_H5022_ONYX_AKA_V01_20180725
MTK_BWC_SUPPORT = yes
MTK_C2K_LTE_MODE = 0
...
#next is sagereal config
#=======================================Sagereal driver begin==========================================#

TRUSTKERNEL_TEE_SUPPORT = yes

sagereal_target_project = k37mv1_bsp

pcb_config = WQ507_H5022_common


sagereal_memory_flash  = EMMC_16GB_2GB_6737m

CUSTOM_KERNEL_RGB_LED = 

CUSTOM_KERNEL_HALL_SUPPORT= 

CUSTOM_KERNEL_SUBCAMERA_LED =yes

sagereal_audio_effect_para  = WQ507_H5022_AKA

SAGEREAL_COCLOCK_SUPPORT=no

sagereal_tp_para= 

sagereal_tee_support = TRUSTKERNEL_tee_6737

sagereal_tee_cert = AKA.Model_A.mt6737m

#sagereal_camera_effect_para  = 

sagereal_fat_config =            

#sagereal_battery_capacity  =    

#sagereal_product_folder = empty  

#=======================================Sagereal driver end==========================================#

#=======================================Sagereal integration begin===================================#
#以下集成宏，如果没有客户需求，请设置为空，避免重复拷贝
sagereal_customer = AKA    #ddm kazam mobiwire

#logo,animation
logo_size = fwvga  #wvga qhd hvga fwvga  fhd

#蓝牙,WLAN名称，不允许出现空格,用“_”代替空格
bluetooth_hostname= Model_A
wlan_ssid= Model_A

#Wi-Fi Direct显示
sagereal_p2p_device_name = Model_A

#add for PC connection name custom 
sagereal_pc_name = Model_A

#默认来电铃声，消息铃声和闹钟铃声,填写资源名称(xxx.mp3)，不允许有空格
config_ringtone=
config_notification = Deneb.ogg
config_alarm = Alarm_Beep_03.ogg

#默认时区,例Asia/Shanghai(不允许出现空格)
config_timezone=

#客制化手机型号名称
SAGEREAL_MODEL_NAME = Model%space%A
SAGEREAL_TARGET_DEVICE = Model_A
SAGEREAL_PRODUCT_NAME = Model_A

#去除不需要的apk 每个apk之间用“*”分开，例：Launcher2*Launcher3*Browser
sagereal_remove_apps= PackageInstaller*Launcher2*Provision*MtkQuickSearchBox*QuickSearchBox*MtkPackageInstaller*MtkDialer*MtkDeskClock*MusicBspPlus*MtkEmail

#=======================================Sagereal  integration end=======================================#
#=======================================Sagereal MMI begin==========================================#

#Redmine 142226 caishaoyu modify for navigationbar 20180724 begin
config_showNavigationBar = false
#Redmine 142226 caishaoyu modify for navigationbar 20180724 end

#Redmine 131224 huangxinxin modify for add GMS 2018-04-27 begin
BUILD_GMS = yes
#Redmine 131224 huangxinxin modify for add GMS 2018-04-27 end

#redmine132612 huangxinxin add factory test 2018-05-04 begin
MTK_HALL_SUPPORT = no
SAGEREAL_FACTORYTEST_VERSION = no
SAGEREAL_FACTORYTEST_LED = no
SAGEREAL_FACTORYTEST_GSENSOR = yes
SAGEREAL_FACTORYTEST_PROXSENSOR = yes
SAGEREAL_FACTORYTEST_FRONTCAMERA = yes
SAGEREAL_FACTORYTEST_SMARTPA = no
SAGEREAL_FACTORYTEST_COMPASS = no
SAGEREAL_FACTORYTEST_GYROSCOPE = no
sagereal_factorydevelopx_app=yes
#redmine132612 huangxinxin add factory test 2018-05-04 end

#Redmine142874 wuzongchen google dialer ui modify 2018-07-31 begin
ui_default_package=com.google.android.dialer
#Redmine142874 wuzongchen google dialer ui modify 2018-07-31 end

#redmine131224 huangxinxin modify for add widevine 2018-05-15 begin
SAGEREAL_WIDEVINE_SUPPORT = yes
#redmine131224 huangxinxin modify for add widevine 2018-05-15 end

#duanyecong modify for Factorymode 2018-7-26 begin
SAGEREAL_FACTORYMODE_SUPPORT = yes
#duanyecong modify for Factorymode 2018-7-26 end

#redmine133989 hejing add for fota 20180518 begin
#adupsfota start
ADUPS_FOTA_SUPPORT=yes
ADUPS_FOTA_WITH_ICON=no
ADUPS_FOTA_WITHOUT_MENU=no
#adupsfota end
#redmine133989 hejing add for fota 20180518 end

#redmine142937 add for soundrecorder_vo1 2018-08-01 begin
SAGEREAL_SoundRecorder_V01=yes
#redmine142937 add for soundrecorder_vo1 2018-08-01 end

#redmine143509 add for old factory 20180806 begin
SAGEREAL_FACTORY_OLD_SUPPORT = yes
#redmine143509 add for old factory 20180806 end
#=======================================Sagereal MMI end==========================================#
