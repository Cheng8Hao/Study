...
#Redmine131224 huangxinxin modify for add GMS 2018-04-27 begin
# GMS interface
ifdef BUILD_GMS
ifeq ($(strip $(BUILD_GMS)), yes)
ifeq ($(strip $(BUILD_AGO_GMS)), yes)
$(call inherit-product-if-exists, vendor/go-gms/products/gms_go.mk)
else
$(call inherit-product-if-exists, vendor/go-gms/products/gms.mk)
endif
#Redmine131224 huangxinxin modify for add GMS 2018-04-27 end
...
ifdef MTK_CARRIEREXPRESS_PACK
 ifndef MTK_REGIONAL_OP_PACK
  ifeq ($(strip $(MTK_CARRIEREXPRESS_PACK)),la)
    ...
    MTK_REGIONAL_OP_PACK = OP17_SPEC0200_SEGDEFAULT OP50_SPEC0200_SEGDEFAULT OP129_SPEC0200_SEGDEFAULT
...
# Export mediatek provided shared libs
PRODUCT_COPY_FILES += \
...
ifeq ($(strip $(WATCHDATA_TEE_SUPPORT)), yes)
  ...
  PRODUCT_PACKAGES   +=    wdtee_listener
  PRODUCT_PACKAGES   +=    libkeymaster
  PRODUCT_PACKAGES   +=    keystore
  PRODUCT_PACKAGES   +=    gatekeeper
  PRODUCT_PACKAGES   +=    77617463-6802-6761-74656B6565706572.secta
  PRODUCT_PACKAGES   +=    77617463-6801-226B-65796D6173746572.secta
  PRODUCT_PROPERTY_OVERRIDES += ro.mtk_watchtrust_tee_support=1
  PRODUCT_PROPERTY_OVERRIDES += ro.hardware.gatekeeper=$(shell echo $(MTK_PLATFORM) | tr '[A-Z]' '[a-z]')
  PRODUCT_PROPERTY_OVERRIDES += ro.hardware.keystore=$(shell echo $(MTK_PLATFORM) | tr '[A-Z]' '[a-z]')
  PRODUCT_PROPERTY_OVERRIDES += ro.hardware.kmsetkey=$(shell echo $(MTK_PLATFORM) | tr '[A-Z]' '[a-z]')
endif
...
ifeq (yes,$(strip $(MTK_RUNNING_BOOSTER_SUPPORT)))
    ...
    ifeq (yes,$(strip $(MTK_RUNNING_BOOSTER_THROTTLE)))
        PRODUCT_PROPERTY_OVERRIDES += ro.vendor.duraspeed_throttle=1
    endif
endif
...
#Redmine114688 tangchangqiang modify for monkey test 2017-12-28 begin
ifeq ($(strip $(SAGEREAL_FACTORY_OLD_SUPPORT)), yes)
PRODUCT_PACKAGES += Factory
endif
#Redmine114688 tangchangqiang modify for monkey test 2017-12-28 end
...
#redmine132612 huangxinxin add factory test 2018-05-04 begin
PRODUCT_PACKAGES += FactoryDevelopX
#duanyecong modify for factorymode begin
ifeq ($(strip $(SAGEREAL_FACTORYMODE_SUPPORT)),yes)
PRODUCT_PACKAGES += FactoryMode
PRODUCT_PACKAGES += libgoogle_key
PRODUCT_PACKAGES += libkphproxy
endif
#duanyecong modify for factorymode end

ifeq ($(strip $(MTK_HALL_SUPPORT)),yes)
       PRODUCT_PROPERTY_OVERRIDES += ro.mtk_hall_support=1
endif
ifeq ($(strip $(SAGEREAL_FACTORYTEST_VERSION)),yes)
       PRODUCT_PROPERTY_OVERRIDES += ro.sr_ftest_version=1
endif
ifeq ($(strip $(SAGEREAL_FACTORYTEST_LED)),yes)
       PRODUCT_PROPERTY_OVERRIDES += ro.sr_ftest_led=1
endif
ifeq ($(strip $(SAGEREAL_FACTORYTEST_GSENSOR)),yes)
       PRODUCT_PROPERTY_OVERRIDES += ro.sr_ftest_gsensor=1
endif
ifeq ($(strip $(SAGEREAL_FACTORYTEST_PROXSENSOR)),yes)
       PRODUCT_PROPERTY_OVERRIDES += ro.sr_ftest_psensor=1
endif
ifeq ($(strip $(SAGEREAL_FACTORYTEST_FRONTCAMERA)),yes)
       PRODUCT_PROPERTY_OVERRIDES += ro.sr_ftest_fcamera=1
endif
ifeq ($(strip $(SAGEREAL_FACTORYTEST_SMARTPA)),yes)
       PRODUCT_PROPERTY_OVERRIDES += ro.sr_ftest_smartpa=1
endif
ifeq ($(strip $(SAGEREAL_FACTORYTEST_COMPASS)),yes)
       PRODUCT_PROPERTY_OVERRIDES += ro.sr_ftest_compass=1
endif
ifeq ($(strip $(SAGEREAL_FACTORYTEST_GYROSCOPE)),yes)
       PRODUCT_PROPERTY_OVERRIDES += ro.sr_ftest_gyroscope=1
endif
#redmine132612 huangxinxin add factory test 2018-05-04 end
...
#redmine142937 add for soundrecorder_vo1 2018-08-01 begin
ifeq ($(strip $(SAGEREAL_SoundRecorder_V01)),yes)
  PRODUCT_PACKAGES += SoundRecorder_V01
endif
#redmine142937 add for soundrecorder_vo1 2018-08-01 end
...
#copy，caishaoyu
ifeq ($(strip $(COMPASS_MMC3630X_DRV)),yes)
  PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,kernel-4.4/drivers/misc/mediatek/sensors-1.0/magnetometer/mmc3630x/libmemsicd3630x.so:vendor/lib/libmemsicd3630x.so)
endif
...
#redmine131224 huangxinxin modify for add widevine 2018-05-15 begin
...
#redmine131224 huangxinxin modify for add widevine 2018-05-15 end
...
ifeq ($(strip $(MTK_SUBSIDY_LOCK_SUPPORT)),yes)
  ...
  PRODUCT_PROPERTY_OVERRIDES += ro.mtk_subsidy_lock_support=1
  PRODUCT_PROPERTY_OVERRIDES += persist.mtk_sim_switch_policy=2
endif

ifeq ($(strip $(MTK_REDBEND_DM_CLIENT_SUPPORT)),yes)
  PRODUCT_PACKAGES += com.redbend.client
  PRODUCT_PACKAGES += dma_config.txt
  PRODUCT_COPY_FILES += vendor/mediatek/proprietary/packages/apps/RedbendDM/lib/libsmm.so:system/lib64/libsmm.so
endif
...
ifeq ($(strip $(MTK_IMSI_SWITCH_SUPPORT)),yes)
  PRODUCT_PROPERTY_OVERRIDES += ro.mtk_imsi_switch_support=1
endif
